...
public class Constant {
	...
	public static final String username = "thangnguyenhuy1988@yahoo.com.vn";//"fae@dts.com";
	...
	public static final String accessoryNeedAttention = "Need Attention";
	// dts category filter
	...
	// model Type
	public static final String modelTypeEarBuds = "Ear-buds";
	public static final String modelTypeInEar = "In-Ear";
	public static final String modelTypeOnEar = "On-Ear";
	public static final String modelTypeOverEar = "Over-Ear";
	public static final ArrayList<String> getType() {
		ArrayList<String> arrayList = new ArrayList<String>();
		arrayList.add(modelTypeEarBuds);
		arrayList.add(modelTypeInEar);
		arrayList.add(modelTypeOnEar);
		arrayList.add(modelTypeOverEar);
		return arrayList;
	}
	// Home heading text
...
//	 public static final String VERSION = "Version";
	 ...
	 public static final String download_Director = "C:\\Users\\TEMP.PSDVN.008\\Downloads\\";
	 public static final String tuning_invalid = "tuning-based-on-JSON.zip";
	 public static final String tuning_hpxtt = "bt-tuning.hpxtt";
	 public static final String tuning_zip = "bt-tuning.zip";
	 public static final String test_upload_cancel = "Test-upload-cancel.dts";
	// public static final String fileGPB = "tuning-based-on-GPB.zip";
	 ...
	 public static final String AUDIO_ROUTE_FILE = "default-headphone-1.1.0.dtscs";
	 ...
	 // Network
	 public static final String RELEASE_NETWORK = "ipconfig /release";
	 public static final String RENEW_NETWORK = "ipconfig /renew";
