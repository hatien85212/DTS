...
public class AddPromotion {
	...
	public static final String SAVE = "//*[@class='create-new-user']";
	...
	public static final String PRODUCT_NAME = "//*[@data-bind='text: productName']";
	...
	public static final String PRODUCT_UDID = "//*[@data-bind='text: productDtsId']";
