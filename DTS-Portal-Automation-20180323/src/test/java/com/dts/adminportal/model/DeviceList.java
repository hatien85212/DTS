...
public class DeviceList {
	public static final String COMPANY_LABEL = ".//*[@id='main-container']/div[2]/div[1]/span[1]";
	public static final String COMPANY_LIST = "//*[@id='company-list']";
	public static final String BRAND_LABEL  = ".//*[@id='main-container']/div[2]/div[1]/span[2]";
	public static final String BRAND_LIST = "//*[@id='brand-list']";
	public static final String TYPE_LABEL = ".//*[@id='main-container']/div[2]/div[1]/span[3]";
	...
	public static final String ACTION_MODULE = "//*[@class='create-new-company-action']";
	public static final String CREATE_NEW_DEVICE = "//*[@id='create-device']";
	public static final String FOOTER = "html/body/footer/p";
