...
public class ProductModel {
	...
	public static final String PRODUCT_TABLE_DATA = "//*[@id='BrandAccessoriesTable']/tbody";
	...
	public enum ProductStatus {
		...
		TUNING_UNSUBMITTED("Unsubmitted"), TUNING_PENDING_APPROVAL("Pending Partner Approval"),  TUNING_PARTNER_UPLOADED("Partner Tuning Uploaded"), TUNING_REQUEST_PENDING("Tuning Request Pending"),
