...
public class VariantInfo {
	...
	public static final String DISPLAYNAME_DEFAULT = "//*[@id='display-variant-name']/div/span[2]";
...
//	public static final String TUNING_ACTION = "//*[@id='requestTuningAction']";
	...
	public static final String REQUEST_REVISED_TUNING_REMOVE = "//*[@id='requestTuningAction'][@action='partnerRequestRevisedTuningRemoved']";
	...
	public static Hashtable<String, String> getElementsInfo(){
	 ...
	 public static final String APPROVE_TUNING_STRING = "Approve Tuning";
	 public static final String DECLINE_TUNING_STRING = "Decline Tuning";
	 ...
	 public static final String REQUEST_REVISED_TUNING_STRING = "Request Revised Tuning";
