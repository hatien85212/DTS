...
//		arrayList.add(homeGhostsText);
	...
	*/
	 ...
	 public static final String PENDING_PARTNER_REVIEWS = "Pending Partner Review";
	 ...
	 public static final String DTS_UPLOADED = "DTS Uploaded";
	 public static final String PARTNER_UPLOADED = "Partner Uploaded";
	 ...
	 public static final String RENDER = "Render Entity UUID";
...
//	 public static final String VERSION = "Version";
	 ...
	 public static final ArrayList<String> getHeaderAccessoriesTableDtsUser(){
		 ArrayList<String> arrayList = new ArrayList<String>();
			arrayList.add(PICTURE);
			arrayList.add(MODEL);
			arrayList.add(VARIANTS);
	...
	// public static final String fileGPB = "tuning-based-on-GPB.zip";
	 ...
	 public static enum IMG_DRAG_DROP_AREA {
		 Tuning_Drag_Drop_Area("TuningDragDropArea.PNG"),
		 Image_Drag_Drop_Area_250("ImageDragDropArea250x250.JPG"),
		 Image_Drag_Drop_Area_500("ImageDragDropArea500x500.JPG"),
		 Image_Drag_Drop_Area_1000("ImageDragDropArea1000x1000.JPG"),
		 Marketing_Drag_Drop_Area("MarketingDragDropArea.PNG");
		 
		 private final String img;

		 IMG_DRAG_DROP_AREA (String img) {
			this.img = img;
		 }
	 ...
	 public static enum TUNING_APPROVAL {
		 Tuning_Rating_is_required("* Headphone:X Tuning Rating is required."),
		 EAN_UPC_is_required("* EAN/UPC is required.");
		 
		 private final String mes;

		 TUNING_APPROVAL (String mes) {
			this.mes = mes;
		 }
