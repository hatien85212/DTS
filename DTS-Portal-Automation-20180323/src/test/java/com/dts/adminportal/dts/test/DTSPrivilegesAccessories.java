...
public class DTSPrivilegesAccessories extends BasePage{
	...
	public void TCPDA_05(){
		...
		productControl.click(UserMgmt.EDIT);
		// 13. Disabled the 'Add and manage products' privilege
		userControl.disablePrivilege(UserEdit.SITE_PRIVILEGES_TABLE, Privileges.privileges.Add_and_manage_products.getName());
		productControl.click(AddUser.SAVE);
		// 14. Perform from step 7 to 10 again
		// Log out DTS portal
		productControl.logout();
...
//		productWf.approveMarketing();
		...
		// Click "Edit" link
		productControl.click(UserMgmt.EDIT);
		// Enable "Publish and suspend accessories" site privilege for above user
		userControl.enableAllPrivileges();
		productControl.click(AddUser.SAVE);
		productControl.click(PageHome.linkAccessories);
		productControl.selectAccessorybyName(data.get("name"));
...
//		productControl.click(VariantInfo.APPROVE_MARKETING);
	...
	public void TCPDA_14(){
		...
		// Disable "Publish and suspend accessories" site privilege for above user
		userControl.enableAllPrivileges();
		userControl.disablePrivilege(UserEdit.SITE_PRIVILEGES_TABLE, Privileges.privileges.Publish_and_suspend_products.getName());
		productControl.click(AddUser.SAVE);
		// Navigate to Product page
		productControl.click(PageHome.linkAccessories);
		// Click Add product link
	...
	public void TCPDA_16(){
		...
		// Click 'Edit' link
		productControl.click(UserInfo.EDIT);
		// Enable "Publish and suspend Products" privilege
		userControl.enableAllPrivileges();
		productControl.click(AddUser.SAVE);
		productControl.click(PageHome.linkAccessories);
		productControl.selectAccessorybyName(dataProduct.get("name"));
	...
	public void TCPDA_21(){
		...
		// Click Edit link
		productControl.click(UserMgmt.EDIT);
		// Enable 'Request accessory tunings' privilege
		userControl.enableAllPrivileges();
		productControl.click(AddUser.SAVE);
	}
	...
	public void TCPDA_22(){
		...
		Assert.assertTrue(productControl.isElementPresent(ProductDetailModel.TITLE_NAME));
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.TUNING_STATUS),ProductDetailModel.ProductStatus.UNSUBMITTED.getName());
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.REQUEST_TUNING),ProductDetailModel.ProductActions.REQUEST_TUNING_REVIEW.getName());
		// 8. Click 'Request DTS Review' link
		productControl.click(ProductDetailModel.REQUEST_TUNING);
		/*
		 ...
		 */
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.TUNING_STATUS),ProductDetailModel.ProductStatus.PENDING_DTS_APPROVAL.getName());
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.REQUEST_TUNING),ProductDetailModel.ProductActions.TUNING_CANCEL_REQUEST.getName());
		// 9. Log out DTS portal
		productControl.logout();
		// 10. Log into DTS portal as a DTS user successfully
		loginControl.login(SUPER_USER_NAME, SUPER_USER_PASSWORD);
		 ...
		 */
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.TUNING_STATUS),ProductDetailModel.ProductStatus.PENDING_DTS_APPROVAL.getName());
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.APPROVE_TUNING),ProductDetailModel.ProductActions.APPROVE_TUNING.getName());
	...
	public void TCPDA_23(){
		 ...
		 */
		Assert.assertEquals(productControl.getTextByXpath(ProductDetailModel.TUNING_STATUS),ProductDetailModel.ProductStatus.DECLINED.getName());
		Assert.assertFalse(productControl.isElementPresent(ProductDetailModel.PARTNER_ACTIONS_STEP_1));
		// Delete product
		productControl.doDelete(ProductDetailModel.DELETE);
	}
	...
	public void TCPDA_24(){
		...
		userControl.enableAllPrivileges();
		userControl.disablePrivilege(AddUser.DTS_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Approve_product_tunings.getName());
		productControl.click(AddUser.SAVE);
		// Log out DTS portal
		productControl.logout();
		/*
	...
	public void TCPDA_25(){
		...
		/*
			...
			10. Go through the marketing approval
		 */
		loginControl.login(SUPER_USER_NAME, SUPER_USER_PASSWORD);
		// 3. Navigate to 'Products' page
		productControl.click(PageHome.linkAccessories);
...
//		productControl.click(ProductDetailModel.DECLINE_MARKETING);
	...
	public void TCPDA_27(){
		...
		userControl.enableAllPrivileges();
		userControl.disablePrivilege(AddUser.DTS_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Approve_marketing_information.getName());
		productControl.click(AddUser.SAVE);
		// Log out
		productControl.logout();
		/*
