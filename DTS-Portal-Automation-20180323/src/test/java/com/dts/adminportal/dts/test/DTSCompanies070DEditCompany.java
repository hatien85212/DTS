...
//		Assert.assertTrue(false);
	...
	public void TC070DbEC_17() {
		companyControl.addLog("ID TC070DbEC_17 : Verify Licensed Product on Licensee Device will show up those options");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
			4. Enable Licensee Device
			5. Navigate Licensed Product drop down box
			VP: Verify Licensed Product on Licensee Device will show up those options:
				+ DTS Ultra
				+ DTS Premium
		...
		*/
		...
		companyControl.click(PageHome.LINK_COMPANY);
		// 3. Click "Add Company" link
		companyControl.click(Companies.ADD_COMPANY);
		// 4. Click to "Enable" button Licensee Device
		companyControl.click(CompanyInfo.LICENSEE_DISABLE);
		
		// VP: Verify Licensed Product on Licensee Device will show up full options
		Assert.assertTrue(companyControl.checkFullLicensedProductCombobox(AddCompany.LICENSEE_PRODUCT));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_18() {
		companyControl.addLog("ID TC070DbEC_18 : Verify can be add DTS Ultra on Licensed Product");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
			2. Enable Licensee Device
			3. Navigate to Licensed Product combobox dropdown
			4. Choose Product type: DTS Ultra
			5. Click to "Add" button
			VP: Can add product type successfully
		*/
		...
		companyControl.click(Companies.ADD_COMPANY);
		// 4. Click to "Enable" button Licensee Device
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
		// 5. Navigate to Licensed Product combobox dropdown
		companyControl.selectOptionByValue(AddCompany.LICENSEE_PRODUCT, LicenseeProductType.HPX_HIGH_2.getName());
		// 6. Click to "Add" button
		companyControl.clickObject(AddCompany.ADD_LICENSEE_PRODUCT);
		
		// VP: Verify can be add DTS Ultra on Licensed Product
		Assert.assertTrue(companyControl.isElementPresent(AddCompany.LISENSEE_PRODUCT_DETAIL,
				LicenseeProductType.HPX_HIGH_2.getName()));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_19() {
		companyControl.addLog("ID TC070DbEC_19 : Verify can be add DTS:X Premium on Licensed Product");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
		...
		*/
		...
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
		// 5. Navigate to Licensed Product combobox dropdown
		companyControl.selectOptionByValue(AddCompany.LICENSEE_PRODUCT, LicenseeProductType.HPX_MEDIUM_2.getName());
		// 6. Click to "Add" button
		companyControl.clickObject(AddCompany.ADD_LICENSEE_PRODUCT);
		
		// VP: Verify can be add DTS:X Premium  on Licensed Product
		Assert.assertTrue(companyControl.isElementPresent(AddCompany.LISENSEE_PRODUCT_DETAIL,
				LicenseeProductType.HPX_MEDIUM_2.getName()));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_20() {
		companyControl.addLog("ID TC070DbEC_20 : Verify can be add DTS Audio Processing on Licensed Product");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
		...
		*/
		...
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
		// 5. Navigate to Licensed Product combobox dropdown
		companyControl.selectOptionByValue(AddCompany.LICENSEE_PRODUCT, LicenseeProductType.HPX_LOW_2.getName());
		// 6. Click to "Add" button
		companyControl.clickObject(AddCompany.ADD_LICENSEE_PRODUCT);
		
		// VP: Verify can be add DTS Audio Processing on Licensed Product
		Assert.assertTrue(companyControl.isElementPresent(AddCompany.LISENSEE_PRODUCT_DETAIL,
				LicenseeProductType.HPX_LOW_2.getName()));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_21() {
		companyControl.addLog("ID TC070DbEC_21 : Verify can be add Headphone:X Beijing on Licensed Product");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
			2. Enable Licensee Device
			3. Navigate to Licensed Product combobox dropdown
			4. Choose Product type: Headphone:X Beijing
			5. Click to "Add" button
			VP: Can add product type successfully
		*/
		...
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
		// 5. Navigate to Licensed Product combobox dropdown
		companyControl.selectOptionByValue(AddCompany.LICENSEE_PRODUCT, LicenseeProductType.HPX_HIGH_1.getName());
		// 6. Click to "Add" button
		companyControl.clickObject(AddCompany.ADD_LICENSEE_PRODUCT);
		
		// VP: Verify can be add Headphone:X Beijing on Licensed Product
		Assert.assertTrue(companyControl.isElementPresent(AddCompany.LISENSEE_PRODUCT_DETAIL,
				LicenseeProductType.HPX_HIGH_1.getName()));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_22() {
		companyControl.addLog("ID TC070DbEC_19 : Verify can be add DTS Headphone:X Kansas City on Licensed Product");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
			2. Enable Licensee Device
			3. Navigate to Licensed Product combobox dropdown
			4. Choose Product type: DTS Headphone:X Kansas City
			5. Click to "Add" button
			VP: Can add product type successfully
		*/
		...
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
		// 5. Navigate to Licensed Product combobox dropdown
		companyControl.selectOptionByValue(AddCompany.LICENSEE_PRODUCT, LicenseeProductType.HPX_MEDIUM_1.getName());
		// 6. Click to "Add" button
		companyControl.clickObject(AddCompany.ADD_LICENSEE_PRODUCT);
		
		// VP: Verify can be add DTS Headphone:X Kansas City on Licensed Product
		Assert.assertTrue(companyControl.isElementPresent(AddCompany.LISENSEE_PRODUCT_DETAIL,
				LicenseeProductType.HPX_MEDIUM_1.getName()));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_23() {
		companyControl.addLog("ID TC070DbEC_23 : Verify can be add DTS Sound on Licensed Product");
		/*
			1. Log into DTS portal as DTS user
			2. Click to "Companies" tab
			3. Click to "Add Company" 
			2. Enable Licensee Device
			3. Navigate to Licensed Product combobox dropdown
			4. Choose Product type: DTS Sound
			5. Click to "Add" button
			VP: Can add product type successfully
		*/
		...
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
		// 5. Navigate to Licensed Product combobox dropdown
		companyControl.selectOptionByValue(AddCompany.LICENSEE_PRODUCT, LicenseeProductType.HPX_LOW_1.getName());
		// 6. Click to "Add" button
		companyControl.clickObject(AddCompany.ADD_LICENSEE_PRODUCT);
		
		// VP: Verify can be add DTS Sound on Licensed Product
		Assert.assertTrue(companyControl.isElementPresent(AddCompany.LISENSEE_PRODUCT_DETAIL,
				LicenseeProductType.HPX_LOW_1.getName()));
	}
	
	@Test(groups="MPG-6318")
	public void TC070DbEC_24() {
		companyControl.addLog("ID TC070DbEC_24 : Verify Lincensed Product on Licensee Device will show up those options when edit old company become Licensee");
		/*
			1. Log into DTS portal as DTS user
			2. Navigate to "Company" page
			3. Click to "Company" tab
			4. Choose old company 
			5. Click to Edit" company info
			6. Enable the Licensee Device
			7. Navigate the Licensed Product drop down box
			VP: Verify Lincensed Product on Licensee Device will show up those options when edit old partner become Licensee: 
				+ DTS Ultra
				+ DTS Premium
				+ DTS Audio Processing
				+ DTS Headphone:X Beijing
		...
		*/
		...
		companyControl.click(CompanyInfo.EDIT);
		// 6. Click to "Enable" button Licensee Device
		companyControl.enableLicensedProduct();
		// 7. Navigate the Licensed Product drop down box
		companyControl.clickObject(CompanyInfo.LICENSEE_DISABLE);
	...
	@Test(groups="MPG-6318")
	public void TC070DbEC_25() {
		companyControl.addLog("ID TC070DbEC_25 : Verify when add only DTS Ultra on Licensee Device company, the product type in App/Device will show up only DTS Ultra");
		/*
			1. Click to "Add Company"
			2. Enable Licensee Device
			3. Navigate Licensed Product drop down box
			4. Choose Product type: DTS Ultra
			5. Click to "Add" button
			6. Fill valid value into all required fields
			7. Click to "Save" button
			8. Log out the DTS user and Login to Licensee user have just created
			9. Navigate the App/Device tab
			10. Click "Add App or Device"
			11. Navigate the Product type drop down box
			VP: The product type have only: DTS Ultra
		*/
		...
		// 4. Click to "Enable" button Licensee Device
		Hashtable<String, String> data = TestData.licenseCompany();
		data.put("licensedProduct", LicenseeProductType.HPX_HIGH_2.getName());
		companyControl.addLicenseeCompany(data, true);
		// VP: Verify can be add Partner
		companyControl.click(PageHome.LINK_COMPANY);
		Assert.assertTrue(companyControl.checkACompanyExistByName(data.get("name")));
		
		// 5. Click "Apps & Devices" tab
		// 6. Click "Add App or Device" link
		appDeviceControl.addNewDevicePage();
		
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, data.get("name"));
		appDeviceControl.waitForAjax();
		appDeviceControl.selectOptionByValue(DeviceEdit.PRODUCT_TYPE, LicenseeProductType.HPX_HIGH_2.getName());
		
		// VP: The product type has only DTS Ultra 
		ArrayList<String> productTypes = appDeviceControl.getAllComboboxOption(DeviceEdit.PRODUCT_TYPE); 
		Assert.assertTrue(productTypes != null && productTypes.size() == 2);
		Assert.assertTrue(productTypes.get(1).equals(LicenseeProductType.HPX_HIGH_2.getName()));
		
		//delete partner
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, DTS_COMPANY_NAME);
		appDeviceControl.waitForAjax();
		companyControl.click(PageHome.LINK_COMPANY);
	...
	@Test(groups="MPG-6318")
	public void TC070DbEC_26() {
		companyControl.addLog("ID TC070DbEC_26 : Verify when add only DTS Premium on Licensee Device company, the product type in App/Device will show up only DTS Premium");
		/*
			1. Click to "Add Company"
			2. Enable Licensee Device
			3. Navigate Licensed Product drop down box
			4. Choose Product type: DTS Premium
			5. Click to "Add" button
			6. Fill valid value into all required fields
			7. Click to "Save" button
			8. Log out the DTS user and Login to Licensee user have just created
			...
			10. Click "Add App or Device"
			11. Navigate the Product type drop down box
			VP: The product type have only: DTS Premium
		*/
		...
		// 4. Click to "Enable" button Licensee Device
		Hashtable<String, String> data = TestData.licenseCompany();
		data.put("licensedProduct", LicenseeProductType.HPX_MEDIUM_2.getName());
		companyControl.addLicenseeCompany(data, true);
		// VP: Verify can be add Partner
		companyControl.click(PageHome.LINK_COMPANY);
		Assert.assertTrue(companyControl.checkACompanyExistByName(data.get("name")));
		...
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, data.get("name"));
		appDeviceControl.waitForAjax();
		appDeviceControl.selectOptionByValue(DeviceEdit.PRODUCT_TYPE, LicenseeProductType.HPX_MEDIUM_2.getName());
		
		// VP: The product type has only DTS Ultra 
		ArrayList<String> productTypes = appDeviceControl.getAllComboboxOption(DeviceEdit.PRODUCT_TYPE); 
		Assert.assertTrue(productTypes != null && productTypes.size() == 2);
		Assert.assertTrue(productTypes.get(1).equals(LicenseeProductType.HPX_MEDIUM_2.getName()));
	...
	@Test(groups="MPG-6318")
	public void TC070DbEC_27() {
		companyControl.addLog("ID TC070DbEC_27 : Verify when add only DTS Audio Processing on Licensee Device company, the product type in App/Device will show up only DTS Audio Processing");
		/*
			1. Click to "Add Company"
			2. Enable Licensee Device
			3. Navigate Licensed Product drop down box
			...
			10. Click "Add App or Device"
			11. Navigate the Product type drop down box
			VP: The product type have only: DTS Audio Processing
		*/
		...
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, data.get("name"));
		appDeviceControl.waitForAjax();
		appDeviceControl.selectOptionByValue(DeviceEdit.PRODUCT_TYPE, LicenseeProductType.HPX_LOW_2.getName());
		
		// VP: The product type has only DTS Audio Processing 
		ArrayList<String> productTypes = appDeviceControl.getAllComboboxOption(DeviceEdit.PRODUCT_TYPE); 
		Assert.assertTrue(productTypes != null && productTypes.size() == 2);
		Assert.assertTrue(productTypes.get(1).equals(LicenseeProductType.HPX_LOW_2.getName()));
	...
	@Test(groups="MPG-6318")
	public void TC070DbEC_28() {
		companyControl.addLog("ID TC070DbEC_28 : Verify when add only DTS Headphone:X Beijing on Licensee Device company, the product type in App/Device will show up only DTS Headphone:X Beijing");
		/*
			1. Click to "Add Company"
			2. Enable Licensee Device
			3. Navigate Licensed Product drop down box
			4. Choose Product type: DTS Headphone:X Beijing
			5. Click to "Add" button
			6. Fill valid value into all required fields
			7. Click to "Save" button
			8. Log out the DTS user and Login to Licensee user have just created
			...
			10. Click "Add App or Device"
			11. Navigate the Product type drop down box
			VP: The product type have only: DTS Headphone:X Beijing
		*/
		...
		// 4. Click to "Enable" button Licensee Device
		Hashtable<String, String> data = TestData.licenseCompany();
		data.put("licensedProduct", LicenseeProductType.HPX_HIGH_1.getName());
		companyControl.addLicenseeCompany(data, true);
		// VP: Verify can be add Partner
		companyControl.click(PageHome.LINK_COMPANY);
		Assert.assertTrue(companyControl.checkACompanyExistByName(data.get("name")));
		...
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, data.get("name"));
		appDeviceControl.waitForAjax();
		appDeviceControl.selectOptionByValue(DeviceEdit.PRODUCT_TYPE, LicenseeProductType.HPX_HIGH_1.getName());
		
		// VP: The product type has only DTS Headphone:X Beijing 
		ArrayList<String> productTypes = appDeviceControl.getAllComboboxOption(DeviceEdit.PRODUCT_TYPE); 
		Assert.assertTrue(productTypes != null && productTypes.size() == 2);
		Assert.assertTrue(productTypes.get(1).equals(LicenseeProductType.HPX_HIGH_1.getName()));
	...
	@Test(groups="MPG-6318")
	public void TC070DbEC_29() {
		companyControl.addLog("ID TC070DbEC_26 : Verify when add only DTS Headphone:X Kansas City on Licensee Device company, the product type in App/Device will show up only DTS Headphone:X Kansas City");
		/*
			1. Click to "Add Company"
			2. Enable Licensee Device
			3. Navigate Licensed Product drop down box
			...
			10. Click "Add App or Device"
			11. Navigate the Product type drop down box
			VP: The product type have only: DTS Headphone:X Kansas City
		*/
		...
		// 4. Click to "Enable" button Licensee Device
		Hashtable<String, String> data = TestData.licenseCompany();
		data.put("licensedProduct", LicenseeProductType.HPX_MEDIUM_1.getName());
		companyControl.addLicenseeCompany(data, true);
		// VP: Verify can be add Partner
		companyControl.click(PageHome.LINK_COMPANY);
		Assert.assertTrue(companyControl.checkACompanyExistByName(data.get("name")));
		...
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, data.get("name"));
		appDeviceControl.waitForAjax();
		appDeviceControl.selectOptionByValue(DeviceEdit.PRODUCT_TYPE, LicenseeProductType.HPX_MEDIUM_1.getName());
		
		// VP: The product type has only DTS Headphone:X Kansas City 
		ArrayList<String> productTypes = appDeviceControl.getAllComboboxOption(DeviceEdit.PRODUCT_TYPE); 
		Assert.assertTrue(productTypes != null && productTypes.size() == 2);
		Assert.assertTrue(productTypes.get(1).equals(LicenseeProductType.HPX_MEDIUM_1.getName()));
	...
	@Test(groups="MPG-6318")
	public void TC070DbEC_30() {
		companyControl.addLog("ID TC070DbEC_30 : Verify when add only DTS Sound on Licensee Device company, the product type in App/Device will show up only DTS Sound");
		/*
			1. Click to "Add Company"
			2. Enable Licensee Device
			3. Navigate Licensed Product drop down box
			...
			10. Click "Add App or Device"
			11. Navigate the Product type drop down box
			VP: The product type have only: DTS Sound 
		*/
		...
		// 4. Click to "Enable" button Licensee Device
		Hashtable<String, String> data = TestData.licenseCompany();
		data.put("licensedProduct", LicenseeProductType.HPX_LOW_1.getName());
		companyControl.addLicenseeCompany(data, true);
		// VP: Verify can be add Partner
		companyControl.click(PageHome.LINK_COMPANY);
		Assert.assertTrue(companyControl.checkACompanyExistByName(data.get("name")));
		...
		appDeviceControl.selectOptionInDropdown(DTSHome.PARTNERS_LIST_DROPDOWN, data.get("name"));
		appDeviceControl.waitForAjax();
		appDeviceControl.selectOptionByValue(DeviceEdit.PRODUCT_TYPE, LicenseeProductType.HPX_LOW_1.getName());
		
		// VP: The product type has only DTS Sound 
		ArrayList<String> productTypes = appDeviceControl.getAllComboboxOption(DeviceEdit.PRODUCT_TYPE); 
		Assert.assertTrue(productTypes != null && productTypes.size() == 2);
		Assert.assertTrue(productTypes.get(1).equals(LicenseeProductType.HPX_LOW_1.getName()));
