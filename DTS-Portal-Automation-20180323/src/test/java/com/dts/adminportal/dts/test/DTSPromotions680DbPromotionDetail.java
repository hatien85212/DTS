...
public class DTSPromotions680DbPromotionDetail extends BasePage {
	...
	public void TC680DbPD_03(){
		...
		String brand_Name = promotionControl.getTextByXpath(PromotionInfo.PRODUCT_BRAND_NAME);
		// 5. Click on the brand link of product info section
		promotionControl.click(PromotionInfo.PRODUCT_NAME);
...
//		}
		Assert.assertEquals(promotionControl.getTextByXpath(ProductDetailModel.BRAND_NAME), brand_Name);
	}
	...
	public void TC680DbPD_04(){
		...
		String productName= promotionControl.getTextByXpath(PromotionInfo.PRODUCT_NAME);
		String brand= promotionControl.getTextByXpath(PromotionInfo.PRODUCT_BRAND_NAME);
		String uuid = promotionControl.getTextByXpath(PromotionInfo.PRODUCT_UDID);
		String type = promotionControl.getTextByXpath(PromotionInfo.PRODUCT_TYPE);
		// 5. Click on the product display name link of product info section
		promotionControl.click(PromotionInfo.PRODUCT_NAME);
		/*
		  	VP: Portal redirects to 040D Product Detail page
