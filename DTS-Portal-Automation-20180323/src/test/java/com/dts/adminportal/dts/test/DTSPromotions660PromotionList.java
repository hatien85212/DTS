...
//		promotionControl.addLog("ID : TC660DPL_07 : Verify that when the Promotion page is loaded, the default filtering value is  �All Brands� and �Active�");
//		/*
//			1. Navigate to DTS portal
//			2. Log into DTS portal as a DTS user successfully
//			3. Navigate to "Promotions" page
...
//	}
	...
	public void TC660DPL_10(){
		...
		System.out.println("Before" + listBeforeSorting);
		Collections.sort(listAfterSorting, String.CASE_INSENSITIVE_ORDER);
	...
	public void TC660DPL_12(){
		...
		productControl.click(PageHome.linkPromotions);
		promotionControl.selectAPromotionByName(PromotionList.PROMOTION_TABLE, dataPromotion.get("name"));
		promotionControl.doDelete(PromotionInfo.DELETE);
