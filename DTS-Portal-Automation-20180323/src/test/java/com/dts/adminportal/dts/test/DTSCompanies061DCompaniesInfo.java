...
//		data.put("partnerships", AddCompany.Partnership_List.Audio_Accessories.getName());
	...
	public void TC061DaCI_11() {
		...
		*/
		...
		companyControl.selectOptionByName(UsersList.FILTER_USER, UsersList.company_Filter.Invited.getName());
		Assert.assertTrue(userControl.checkUserExistByEmail(data_user.get("email")));
		companyControl.selectOptionByName(UsersList.FILTER_USER, UsersList.company_Filter.Suspended.getName());
...
//		11. Perform step 6 to 7 again
		...
		Assert.assertTrue(companyControl.getTextByXpath(UserMgmt.STATUS).contains(UsersList.company_Filter.Invited.getName()));
	...
	public void TC061DaCI_12() {
		...
		/*
			...
			3. Select a company from companies list
			4. Click �Suspend� link in 061Da Company info page
			5. Click �Suspend� button on confirmation dialog
			VP. Verify that the portal is redirected to companies list page and the deleted company is displayed in Suspended list
			6. Navigate to �Users� page
			7. Click �Add New User� link
			8. List out the �Company� compbobox
		...
		*/
		...
		Hashtable<String,String> brandData = TestData.brandDraft();
		 ...
		 * VP: Verify that the suspended company is not displayed in �Company� combobox
		 */
		Assert.assertFalse(ListUtil.checkListContain(companyList,data.get("name")));
		// 9. Navigate to �Companies� page
		companyControl.click(PageHome.LINK_COMPANY);
		// 10. Filter the Suspended companies
		companyControl.selectOptionByName(Companies.FILTER, filter);
		...
		Assert.assertTrue(ListUtil.checkListContain(companyList,data.get("name")));
		// Delete company
		companyControl.click(PageHome.LINK_COMPANY);
