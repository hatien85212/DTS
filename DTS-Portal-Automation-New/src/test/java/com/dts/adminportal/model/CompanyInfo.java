...
public class CompanyInfo {
	...
	public static final String BRANDNAME_LIST = "/*[@id='brandList']/div/a";
	...
	public static final String LICENSE_DEVICE = "//*[@id='licensee-device-view']";
	// Actions
	...
	// Licensee
	public static final String LICENSEE_ENABLE = "//*[@id='partner-device-licensee-part']/div[1]/div/div/span[1]";
	public static final String LICENSEE_DISABLE = "//*[@id='partner-device-licensee-part']/div[1]/div/div/span[3]";
	public static final String LICENSEE_PRODUCT_LABEL = "//*[@id='partner-device-licensee-setting']/div[1]/label";
	public static final String LICENSEE_HEADPHONE_LABEL = "//*[@id='partner-device-licensee-setting']/div[1]/label";
	public static final String LICENSEE_PRODUCT_SELECT = "//*[id='partner-licensed-product-select']";
	public static final String ADD_LICENSEE_PRODUCT = "//*[@id='add-licensed-product-btn']";
	public static final String LICENSE_HEADPHONE = "//*[@id='licensed-headphone-filter']";
