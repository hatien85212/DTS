...
/*
	...
	public void APIU_01(){
		...
		// Create request body
		JSONObject requestBody = APIUtil.parseDataToJsonObject(jsonData.get(APIData.ADD_PARTNER_USER).toString());
		// Send a sample POST request as following:
		// POST http://devportal.dts.com/saap/api/account HTTP/1.1
		JSONObject requestResult = APIUtil.sendPost(APIData.ADD_USER_URL, productWf.csrfToken, productWf.cookie, requestBody);
		/*
	...
	public void APIU_02(){
		...
		productWf.loginAndSetTokenAndCookie(DTS_SECURITY_USER, DTS_SECURITY_PASSWORD);
		// Create request body
		JSONObject requestBody = APIUtil.parseDataToJsonObject(jsonData.get(APIData.EDIT_PARTNER_USER).toString());
//		String requestBody = jsonData.get(APIData.EDIT_PARTNER_USER).toString();
	...
	public void APIU_03(){
		...
		// Disable "Manage audio routes" privileges
		userControl.enableAllPrivileges();
		userControl.disablePrivilege(AddUser.DTS_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName());
		userControl.click(AddUser.SAVE);
		// Logout user
		userControl.logout();
		// Login DTS portal as DTS user above
		productWf.loginAndSetTokenAndCookie(DTS_SECURITY_USER, DTS_SECURITY_PASSWORD);
		// Create request body
		JSONObject requestBody = APIUtil.parseDataToJsonObject(jsonData.get(APIData.ADD_DTS_USER).toString());
	...
	public void APIU_04(){
		...
		// Create request body
		JSONObject requestBody = APIUtil.parseDataToJsonObject(jsonData.get(APIData.EDIT_DTS_USER).toString());
		requestBody.put("phone", RandomStringUtils.randomNumeric(10));
		// Send a sample POST request as following:
		// POST http://devportal.dts.com/saap/api/account HTTP/1.1
	...
	public void APIU_05(){
		...
		// POST http://devportal.dts.com/saap/api/account HTTP/1.1
		JSONObject requestResult = APIUtil.sendGet(APIData.GET_USER_LIST_URL, productWf.csrfToken, productWf.cookie);
		/*
		 * {"apiErrorCode":"PEMISSION_DENY","message":"You don't have permission."}
		 */
		Assert.assertEquals(requestResult.get("message").toString(), APIData.ERROR_MESSAGE);
	...
	public void APIU_08(){
		...
		productWf.loginAndSetTokenAndCookie(PARTNER_DTS_SECURITY_USER, PARTNER_DTS_SECURITY_PASSWORD);
		// Create request body
		JSONObject requestBody1 = APIUtil.parseDataToJsonObject(jsonData.get(APIData.ADD_DTS_USER).toString());

		// Send a sample POST request as following:
		// POST http://devportal.dts.com/saap/api/account HTTP/1.1
		JSONObject requestResult1 = APIUtil.sendPost(APIData.ADD_USER_URL, productWf.csrfToken, productWf.cookie, requestBody1);
		/*
		 * {"apiErrorCode":"PEMISSION_DENY","message":"You don't have permission."}
		 */
	...
	public void APIU_09(){
		...
		// Create request body
		JSONObject requestBody1 = APIUtil.parseDataToJsonObject(jsonData.get(APIData.EDIT_DTS_USER).toString());
		// Send a sample POST request as following:
		// POST http://devportal.dts.com/saap/api/account HTTP/1.1
		JSONObject requestResult1 = APIUtil.sendPost(APIData.ADD_USER_URL, productWf.csrfToken, productWf.cookie, requestBody1);
		/*
	...
	public void APIU_12(){
		 ...
		 * {"apiErrorCode":"PEMISSION_DENY","message":"You don't have permission."}
		 */
		Assert.assertEquals(requestResult.get("message").toString(), APIData.ERROR_MESSAGE_CHANGE_USER_OWN_EMAIL);
		//log out
		userControl.logout();
		// Login DTS portal as DTS user above
		loginControl.login(DTS_SECURITY_USER, DTS_SECURITY_PASSWORD);
		 ...
		 * {"apiErrorCode":"PEMISSION_DENY","message":"You don't have permission."}
		 */
		Assert.assertEquals(requestResult1.get("message").toString(), APIData.ERROR_MESSAGE_CHANGE_USER_OWN_EMAIL);
	}
	...
	public void APIU_13(){
		...
		JSONObject dtsUserData = APIUtil.parseDataToJsonObject(jsonData.get(APIData.ADD_DTS_USER).toString());
		dtsUserData.put("userEmail", dtsEmail);
		dtsUserData.put("email", dtsEmail);
		JSONObject newDTSUser = APIUtil.sendPost(APIData.ADD_USER_URL, productWf.csrfToken, productWf.cookie, dtsUserData);
		// Get a company ID
		...
		JSONObject partnerUserData = APIUtil.parseDataToJsonObject(jsonData.get(APIData.ADD_PARTNER_USER).toString());
		partnerUserData.put("partnerId", companyID);
		partnerUserData.put("userEmail", partnerEmail);
		partnerUserData.put("email", partnerEmail);
		
		JSONObject newPartnerUser = APIUtil.sendPost(APIData.ADD_USER_URL, productWf.csrfToken, productWf.cookie, partnerUserData);
		// Log out
		userControl.logout();
		...
		// Send a sample GET request using partner's session and CSRF token as following:
		// GET http://devportal.dts.com/saap/api/resetUserPassWord/36 HTTP/1.1
		JSONObject requestResult = APIUtil.sendGet(APIData.RESET_USER_PASSWORD_URL(newDTSUser.get("id").toString()), productWf.csrfToken, productWf.cookie);
		JSONObject requestResult1 = APIUtil.sendGet(APIData.RESET_USER_PASSWORD_URL(newPartnerUser.get("id").toString()), productWf.csrfToken, productWf.cookie);
		/*
	...
	public void APIU_14(){
		...
		// Send a sample GET request using partner's session and CSRF token as following:
		// GET http://devportal.dts.com/saap/api/resetUserPassWord/36 HTTP/1.1
		JSONObject requestResult = APIUtil.sendGet(APIData.RESET_USER_PASSWORD_URL(newPartnerUser.get("id").toString()), productWf.csrfToken, productWf.cookie);
		...
		productWf.loginAndSetTokenAndCookie(SUPER_USER_NAME, SUPER_USER_PASSWORD);
		// Delete user
		APIUtil.sendHTTPRequest("DELETE", APIData.DELETE_USER_URL(newPartnerUser.get("id").toString()), productWf.csrfToken, productWf.cookie, "");
	}
