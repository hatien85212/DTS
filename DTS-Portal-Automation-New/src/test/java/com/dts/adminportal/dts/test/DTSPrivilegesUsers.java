...
public class DTSPrivilegesUsers extends BasePage{
	...
	public void TCPUSR_02() throws InterruptedException {
		...
		Thread.sleep(5000);
		// 6. Enable the  �Add and manage DTS users� privilege
		userControl.enablePrivilege(AddUser.DTS_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName());
		// 7. Disable the �Add and manage users� privilege
	...
	public void TCPUSR_05() {
		...
		userControl.click(UserMgmt.EDIT);
		// 6. Enable the  �Add and manage DTS users� privilege
		userControl.enablePrivilege(UserEdit.DTS_SITE_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName());
		// 7. Disable the �Add and manage users� privilege
		userControl.disablePrivilege(UserEdit.SITE_PRIVILEGES_TABLE, Privileges.privileges.Add_and_manage_users.getName());
		userControl.click(AddUser.SAVE);
		// 8. Log out DTS portal
		userControl.logout();
		// 9. Log into DTS portal as above DTS user successfully
	...
	public void TCPUSR_07() {
		...
		userControl.enablePrivilege(UserEdit.DTS_SITE_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName());
		// 7. Enable the �Add and manage users� privilege
		userControl.enablePrivilege(UserEdit.SITE_PRIVILEGES_TABLE, Privileges.privileges.Add_and_manage_users.getName());
		userControl.click(AddUser.SAVE);
		// 8. Log out DTS portal
		userControl.logout();
		// 9. Log into DTS portal as above DTS user successfully
...
//			String company = userControl.getCompanyOfUser(PARTNER_DTS_EMAIL);
//			companyControl.click(PageHome.LINK_COMPANY);
//			if (companyControl.selectACompanyByName(company)) {
...
//		userControl.deleteUserByEmail(DTS_EMAIL);
	 ...
	 */
	@Test
	public void TCPUSR_17() throws InterruptedException {
...
//		userControl.deleteUserByEmail(DTS_EMAIL);
	...
	public void TCPUSR_23() {
		...
		Assert.assertFalse(ListUtil.checkListContain(privileges,Privileges.privileges.Add_and_manage_products.getName()));
		// Delete user
		userControl.doDelete(UserMgmt.DELETE_ACCOUNT);
	}
	...
	public void TCPUSR_24() {
		...
		Assert.assertFalse(ListUtil.checkListContain(privileges,Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName()));
		// Delete user
		userControl.doDelete(UserMgmt.DELETE_ACCOUNT);
	}
...
//		userControl.disablePrivilege(AddUser.DTS_PRIVILEGES_TABLE, Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName());
		...
		//10. Change user own email address to another
		//11. Click "Save" link
		String newemail="Test"+RandomStringUtils.randomNumeric(5)+"@mailinator.com";
		...
		userControl.enablePrivilege(AddUser.PRIVILEGES_TABLE, Privileges.dtsPrivileges.Add_and_manage_DTS_users.getName());
