...
public class PartnerCompanies070PEditCompany_071Contact_072EditBrand extends BasePage{
	...
	public void TC071PaC_01(){
		...
		String message1 = "Please select user";
		...
		Assert.assertTrue(companyControl.getTextByXpath(PartnerCompanyInfo.EMAIL).contains(email));
	...
	public void TC072PEBI_01(){
		 ...
		 */
		//Precondition:
		userWf.loginAndDisablePrivilege(PARTNER_USER, Privileges.Edit_brand_info, false);
		// Log out
