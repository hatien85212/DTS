...
//	}
	...
	public void TC025PP_01(){
		...
		Assert.assertEquals(userControl.getTextByXpath(PartnerHomePage.PAGE_HEADER), PartnerHomePage.TOP_NAVIGATION_MESSAGE[0] + PARTNER_COMPANY_NAME);
		// Get Welcome message position
		int welcomeMessage_Pos = driver.findElement(By.xpath(PartnerHomePage.PAGE_HEADER)).getLocation().y;
		userControl.addLog(PartnerHomePage.TOP_NAVIGATION_MESSAGE[1] + welcomeMessage_Pos);
		// Get DTS Logo position
		int dtsLogo_Pos = driver.findElement(By.xpath(PartnerHomePage.HOME_LOGO)).getLocation().y;
		userControl.addLog(PartnerHomePage.TOP_NAVIGATION_MESSAGE[2] + dtsLogo_Pos);
		/*
	...
	public void TC025PP_03(){
		...
		loginControl.login(SUPER_PARTNER_USER, SUPER_PARTNER_PASSWORD);
		// Navigate to product page
		userControl.click(PageHome.LINK_PARTNER_ACCESSORIES);
		...
		// 3. Navigate to "userControl" page
