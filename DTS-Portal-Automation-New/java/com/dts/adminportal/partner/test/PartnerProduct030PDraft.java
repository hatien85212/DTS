...
public class PartnerProduct030PDraft extends BasePage{
	...
	public void TC030PCD_02(){
		...
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.VERSION, Constant.ACCESSORY_DRAFT));
		// Tuning status is DTS request pending.
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.TUNNING_STATUS, Constant.DTS_REQUEST_PENDING));
	...
	public void TC030PCD_04(){
		...
		*/
		...
		Assert.assertTrue(productControl.checkAnAccessoryExistByName(data.get("name")));
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.VERSION, Constant.ACCESSORY_DRAFT));
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.TUNNING_STATUS, Constant.PENDING_DTS_APPROVAL));
	...
	public void TC030PCD_05(){
		...
		*/
		...
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.TUNNING_STATUS, Constant.APPROVED));
		// Marketing status must be Unsubmitted.
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.MARKETING_STATUS, Constant.UNSUBMITTED));
	...
	public void TC030PCD_06(){
		...
		*/
		...
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.MARKETING_STATUS, Constant.PENDING_DTS_MARKETING_REVIEW));
...
//		productControl.click(ProductDetailModel.APPROVE_MARKETING);
		...
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.TUNNING_STATUS, Constant.APPROVED));
		// Marketing status must be Pending DTS Marketing Review.
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.MARKETING_STATUS, Constant.APPROVED));
...
//		productControl.click(ProductDetailModel.PUBLISH);
		 ...
		 */
		Assert.assertTrue(productControl.checkAnAccessoryExistByName(data.get("name")));
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.PUBLISHED, Constant.PUBLISHED));
...
//		//
		 ...
		 */
		Assert.assertTrue(productControl.checkAnAccessoryExistByName(data.get("name")));
		Assert.assertTrue(productControl.verifyValueColumn(PageHome.BRAND_ACCESSORIES, Constant.PUBLISHED, "Suspended"));
