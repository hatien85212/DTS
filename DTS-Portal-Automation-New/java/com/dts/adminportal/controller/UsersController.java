...
//		System.out.println(Calendar.getInstance().getTime());
	...
	public boolean checkPartnerUserInfo(PartnerUserInfo userInfo,
		...
		try {
			waitForAjax();
			String firstname = driver.findElement(By.xpath(elementsInfo.get("firstname"))).getText();
			String lastname = driver.findElement(By.xpath(elementsInfo.get("lastname"))).getText();
			...
			// check name
			if (firstname.contains(userInfo.getFirstName()) && lastname.contains(userInfo.getLastName())) {
				addLog("name correct : " + firstname + " " + lastname);
			} else {
				addLog("name inccorect : "  + firstname + " " + lastname + " : "
