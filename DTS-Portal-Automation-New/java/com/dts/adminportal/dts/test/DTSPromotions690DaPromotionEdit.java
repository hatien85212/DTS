...
//	}
	...
	public void TC690DaPE_06(){
		...
		Assert.assertTrue(promotionControl.isElementPresent(ProductDetailModel.UPDATE_PRODUCT_INFO)); 
		//Assert.assertTrue(promotionControl.isElementPresent(".//*[@id='view-current-model']"));// fix for pass
		//This testcase failed due to the element name is "view current version"	
	}
